...
- Authoritative design: `docs/superpowers/specs/2026-07-23-live-av-recording-design.md`.
...
**Files:**
- Create: `docs/superpowers/validation/2026-07-23-live-av-recording-report.md`
...
```bash
git add -- docs/superpowers/validation/2026-07-23-live-av-recording-report.md
git diff --cached --name-only
```
