...
- HCZ complete-run progression: frames 125, 374, 624, 896, 898, 940, 953, 957, 973, 974, 1020, 1581, 1671, 2486, 2501, 2635, 2801, 2894, 2976, 3066, 3124, 3318, 3355, 3850, 4286, 4403, 4872, 5726, 5995, 6912, 7341, 8451, 8452, 8683, 8968, and 9045 have been cleared or advanced by the release-remediation sidekick/object slices. The current HCZ first error is frame 9337 main-player `x_speed` (`expected=0x02C0`, `actual=0x0274`) after the HCZ miniboss vortex release. The frame-5726 native-P2 Tails vertical-velocity sign mismatch was resolved by preserving the ROM collapsing-platform standing flag through monitor release, frame 5995 by applying ROM chain-leader healing for despawned sidekicks, frame 6912 by aligning HCZ bridge release ordering, frame 7341 by preserving HCZ moving-platform ride publication, frame 8451/8452 by correcting miniboss object-control and hit-latch handoff timing, frame 8683 by aligning miniboss rocket routine publication, frame 8968 by delaying vortex player pull until the ROM raw-animation wind-up reaches the callback, and frame 9045 by driving the water-effect routine gate plus first-contact capture order from the ROM vortex helper sequence.
