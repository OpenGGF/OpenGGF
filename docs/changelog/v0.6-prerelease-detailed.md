...
- **docs(audio): close the S3K SMPS meta-command finding with ROM reachability
  evidence.** Sequencing every shipped S&K music entry (`0x01-0x33`), S3 music
  ...
  copying. The ROM-backed guard and native Z80 contracts are recorded in
