...
- **Fast FM joins the 0.6 delivery work.** New configurations select `fast`,
  ...
  comparison, matched benchmarks and universal packaging. Integration and
  post-merge verification remain pending; see the [FM evidence](../architecture/validation/audio/2026-09-06-fast-fm-release.md).
