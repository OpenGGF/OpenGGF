...
- **Fast FM joins the 0.6 delivery work.** New configurations select `fast`,
  ...
  Remaining LFO checks and final integrated suites/benchmarks still block
  delivery; see the [FM evidence](../architecture/validation/audio/2026-09-06-fast-fm-release.md).
