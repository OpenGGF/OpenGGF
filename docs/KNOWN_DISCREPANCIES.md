...
LZ `Map_Jaws` / `Map_Burro` tables, the GHZ/SLZ `Map_Smash` table, the LZ
`Map_Harp` table, the shared button `Map_But` table, the SBZ2 `Map_FFloor`
...
have been ratcheted down. The current object-provider budget is 1312 handwritten
