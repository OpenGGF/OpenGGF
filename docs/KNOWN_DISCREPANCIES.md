...
`Map_Bump` table, the GHZ `Map_Moto` / `Map_Newt` tables, the GHZ/SLZ `Map_Smash` table, the
...
have been ratcheted down. The current object-provider budget is 974 handwritten
