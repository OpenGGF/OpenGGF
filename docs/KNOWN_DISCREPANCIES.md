...
GHZ/SLZ `Map_Smash` table, the LZ `Map_Harp` table, the shared button `Map_But`
...
have been ratcheted down. The current object-provider budget is 1334 handwritten
