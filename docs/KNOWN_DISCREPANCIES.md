...
LZ `Map_Jaws` / `Map_Burro` / `Map_Flap` tables, the GHZ/SLZ `Map_Smash`
table, the LZ `Map_Harp` table, the shared button `Map_But` table, the SBZ2
...
have been ratcheted down. The current object-provider budget is 1306 handwritten
