...
`Map_Elev` / `Map_Circ` / `Map_Stair` tables, the SBZ vanishing platform
`Map_VanP` table, the SBZ2
...
have been ratcheted down. The current object-provider budget is 529 handwritten
