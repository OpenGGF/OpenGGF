...
The published chain now supplies route evidence. The [first frontier round](../research/trace/2026-09-14-kis2-chain-frontier.md) adds chip PLC queue ownership, solo object prelude, wall-grab terrain fit and glide landing corrections; the first special-stage return remains open.
