...
- Source of truth: `docs/skdisasm/sonic3k.asm`. **The `docs/*disasm` symlinks
  currently point at a nonexistent `/home/farrell/...` path.** If broken,
...
- Build on JDK 21: `export JAVA_HOME=/home/linuxbrew/.linuxbrew/Cellar/openjdk@21/21.0.12/libexec`
  before any `mvn` (system default is JDK 26 and produces phantom failures).
...
```bash
export JAVA_HOME=/home/linuxbrew/.linuxbrew/Cellar/openjdk@21/21.0.12/libexec
