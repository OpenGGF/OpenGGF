...
| GRAVITY: `$5C` hub, `$5F` room, `$61` puzzle | none of the three contains a `Reverse_gravity_flag` reference; they move the player with `object_control` | — | — | missing | unrun | Slice 3 |
