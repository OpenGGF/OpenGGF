...
| OBJECT: traversal families `$25 $32 $37` (32 placements) | `Obj_LRZTurbineSprites` (18), `Obj_LRZSpikeBallLauncher` (9), `Obj_LRZChainedPlatforms` (3) | native | — | not implemented | open | Slice 7's remainder |
