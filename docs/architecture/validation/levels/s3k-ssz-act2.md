...
| BOSS: Mecha Sonic phase, forced run, Super phase, Master Emerald | `Obj_SSZEndBoss` act-2 init `($220,$4A0)`, `loc_7B8E6`..`loc_7BBE0`, `Obj_SSZ2_Boss` (36 routines), burst `loc_7C6F0`/`ChildObjDat_7D4A8`, emerald `loc_7C818` | 320 Knuckles | `TestS3kSszAct2FinaleHeadless`, `TestS3kSszMechaSpawnHeadless` | partial: act-2 init, fresh eight-hit Super phase, transformation/forced-run bridge, all 36 native dispatcher slots, eight-way harmful energy burst, ROM-art Master Emerald, arena/music handoff and save stop line; attached laser/missile children pending | yes into distinct Super dispatcher | bridge, burst children, emerald and graph fields captured; graph round trip pending | route order, routine byte domain, waits, eight `word_7D172` velocity rows and emerald ROM addresses source-matched; remaining child timing pending | open | Add the attached laser/missile children and graph rewind spot |
