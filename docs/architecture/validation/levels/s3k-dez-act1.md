...
| PLACEMENT: 365 act 1 objects | [inventory](../../research/s3k-zones/dez-object-inventory.md) | — | `TestS3kDezPlacementCensus` | 164 concrete / 201 placeholder | pass | Slices 3-6. Slice 3's `$5A` gravity tube is act 1's only gravity object and its 24 placements are the whole of this act's move from 140 concrete |
