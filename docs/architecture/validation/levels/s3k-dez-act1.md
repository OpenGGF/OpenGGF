...
| GRAVITY: `$61` gravity puzzle, 1 act 1 placement (`$2690,$0840`, inside the `$5F` corridor) | `Obj_DEZGravityPuzzle`, sonic3k.asm:96087-96258 | — | — | missing | unrun | Needs `SolidObjectFull2`, a six-piece child sprite and the `MHZ_pollen_counter` panel bitfield; ROM reading is in the plan |
