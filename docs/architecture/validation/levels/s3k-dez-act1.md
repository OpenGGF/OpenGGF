...
| Claim | State |
| --- | --- |
| Implemented | Presentation foundation, runtime event words and 280/365 concrete placements, including gravity tubes, turbine room/puzzle/bumper walls, energy bridges, Spikebonkers and Chainspikes. Remaining objects, miniboss and act change are open |
...
| PLACEMENT: 365 act 1 objects | [inventory](../../research/s3k-zones/dez-object-inventory.md) | — | `TestS3kDezPlacementCensus` | 280 concrete / 85 placeholder | pass | Remaining families are listed in the census and bring-up plan; implementation counts do not certify a route |
