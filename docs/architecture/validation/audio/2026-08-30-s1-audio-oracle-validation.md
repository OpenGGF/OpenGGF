...
| Break-it-on-purpose, fixture side | tick 5000 `tempoTimeout` 3→4 in a temp copy → `global_state_mismatch, tick 5000, field tempo_timeout, reference 4, openggf 3`, exit 3 |
| Break-it-on-purpose, engine side | tick 3001 event 0 `ym2612 p0 reg $A4` 34→35 in a temp copy → `event_value_different, tick 3001, event 0`, exit 3 |
