...
`e4716970d`; they do not change production ownership or the measured graph.
...
`e4716970d`, the authority guard passes 23/23 after runtime-name, enumeration,
...
qualified-alias mutations were added. Authority plus ownership passes 26/26;
including the reader lifecycle gives 32/32. The focused migration set passes
179/179. Existing
...
through `e4716970d` pass their focused acceptance matrix. The design is
