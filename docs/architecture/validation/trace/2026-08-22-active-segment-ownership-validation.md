...
`c59e3320c`; they do not change production ownership or the measured graph.
...
`c59e3320c`, the authority guard passes 25/25 after runtime-name, enumeration,
...
loader/field-alias mutations were added. Authority plus ownership passes 28/28;
including the reader lifecycle gives 34/34. The focused migration set passes
179/179. Existing
...
through `c59e3320c` pass their focused acceptance matrix. The design is
