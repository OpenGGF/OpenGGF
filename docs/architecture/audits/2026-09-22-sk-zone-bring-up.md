...
| LRZ | Ordinary native320 Sonic+Tails now completes Act1 and Act2 from cold entry in43761 inputs, zero deaths, reaching the boss act with six rings/no shield (`7691f0eb3`). Act1 has185 and Act2 has81 full-registry replay spots. The boss act is implemented and has a12820-input standalone completion with declared fire shield/37rings; completing the actual cold carry remains in progress. Native timing/pixel matching and remaining width/donor/roster/lifecycle products remain open. |
