...
`4b21e4b33`. They did not change the production ownership graph or supersede
the full-suite/trace measurements above. At that correction head the authority
guard passes 21/21, authority plus ownership passes 24/24, and the combined
reader gate passes 30/30.
