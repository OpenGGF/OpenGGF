...
`c59e3320c`, the authority guard passes 25/25, authority plus ownership passes
28/28, the combined reader gate passes 34/34, and focused migration tests pass
