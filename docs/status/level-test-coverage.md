...
| S3K | `S3K_SLOT_MACHINE` | Audit pending; `TestS3kSlotGlassPriority` checks ROM glass layering at bootstrap and after update/render. Viewport, donor/team and rewind visual breadth remain unaudited. |
