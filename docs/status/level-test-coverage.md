...
| S3K | `S3K_LAVA_REEF_1` | [Act 1 matrix](../architecture/validation/levels/s3k-lrz-act1.md) - v2 bring-up through slice 3a (partial): 609 placements with 199 still placeholders (239 at the slice 0 baseline), 331 live rings, census ratchet in place; scroll, animated tiles, rock sprites, lava blocks and the `$1E` dash elevator land, while the rest of the traversal objects, badniks, miniboss and the seamless handover are open |
| S3K | `S3K_LAVA_REEF_2` | [Act 2 matrix](../architecture/validation/levels/s3k-lrz-act2.md) - v2 bring-up through slice 2: 455 placements with 277 still placeholders (281 at the slice 0 baseline), 281 live rings; scroll, animated tiles and rock sprites land, while objects, the Death Egg background sprite and both exits are open |
