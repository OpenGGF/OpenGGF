...
| S3K | `S3K_SKY_SANCTUARY_2` | [Act 2 matrix](../architecture/validation/levels/s3k-ssz-act2.md) — v2 bring-up in progress; placement census pinned to the ROM; native/wide Knuckles arrival and mid-rise replay pass; encounter camera oscillator, long fractional offset and graph replay covered; background, palette, crane, both boss phases and full route remain open |
