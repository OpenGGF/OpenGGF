...
> S3K bug ledger. Use `docs/status/s3k-known-bugs.md` for durable bug writeups and
> `docs/status/trace-frontier-log.md` for the current complete-run frontier state.
