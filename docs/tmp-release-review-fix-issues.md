...
| RRF-014 | Medium | deferred | Runtime assets | S1 embedded runtime data from docs/disassembly remains documented and ratcheted; replacing the legacy tables with ROM-backed loaders is broad migration work and is tracked as bounded release debt. | `TestArchitecturalSourceGuard.java`, `docs/KNOWN_DISCREPANCIES.md`, related S1 assets |
