...
- **S3K Death Egg:** the Death Egg acts now hold their background still instead of scrolling it
  ...
  columns stop accepting new riders after defeat. The destination final boss now creates its entry floor, restores carried rings/time and progresses through the forced run-in to the hand phase, with retained boss/floor rendering and a single centred widescreen planet. Complete encounter validation remains in progress.
