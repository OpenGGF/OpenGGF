...
*   **ROM Requirement:** The engine now supports Sonic 1, Sonic 2, and Sonic 3&K modules. Keep the relevant ROMs in the project root (typically gitignored) as `s1.gen`, `s2.gen`, and `s3k.gen`. Expected hashes: S1 World REV01 CRC32 `AFE05EEE` / SHA-1 `69E102855D4389C3FD1A8F3DC7D193F8EEE5FE5B`; S2 World REV01 CRC32 `7B905383` / SHA-1 `8BCA5DCEF1AF3E00098666FD892DC1C2A76333F9`; S3K locked-on combined CRC32 `63522553` / SHA-1 `CFBF98C36C776677290A872547AC47C53D2761D6`. S3K-focused tests should pass `-Ds3k.rom.path=s3k.gen` when needed.
