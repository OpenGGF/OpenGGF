...
7. Implement the fix:
     ...
     - Gate divergences at the narrowest owning abstraction:
      ...
      current `PhysicsFeatureSet` bridge, and later a typed `GameRules` record,
