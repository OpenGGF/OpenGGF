...
log:write('movie_frame,label,zone_act,lfc,cam_x,cam_y,p1_x,p1_y,p2_x,p2_y,bg_routine,fg4,shake,cycle0,fab8,pal4_c1,pal4_c2,pal2_c0,chaos,super,emeralds,watch_code,watch_routine,watch_x,watch_y,watch_hp,watch_status,watch_yvel,p1_status\n')
...
while true do
  ...
  if cw then
    ...
    log:write(string.format('%d,%s,%04X,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%04X,%04X,%04X,%d,%d,%s,%08X,%d,%d,%d,%d,%02X,%d,%02X\n',
