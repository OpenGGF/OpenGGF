...
-- Screen_shake_offset $EECE, Palette_cycle_counters $F650, _unkFAB8 $FAB8, Normal_palette $FC00,
...
log:write('movie_frame,label,zone_act,lfc,cam_x,cam_y,p1_x,p1_y,p2_x,p2_y,bg_routine,fg4,shake,cycle0,fab8,pal4_c1,pal4_c2,pal2_c0\n')
...
while true do
  ...
  if cw then
    log:write(string.format('%d,%s,%04X,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%04X,%04X,%04X\n',
      ...
      mainmemory.read_u16_be(0xFC32),mainmemory.read_u16_be(0xFC34),mainmemory.read_u16_be(0xFC10)))
