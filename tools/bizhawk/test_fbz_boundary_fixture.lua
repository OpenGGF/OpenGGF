...
local boundaries={
 ...
 {id="fbz2-boundary-outdoor",act=2,normal=4,region_address=0xEEC0,x=0x1000,y=0xA3F,region=0,address=0xB014,forward=0xA41,reverse=0xA3F}}
...
for _, settles in ipairs({false,true}) do
 ...
 mainmemory={read_u32_be=function()return 0 end,read_u8=function(a)return a==0xB005 and 2 or 0 end,read_u16_be=function(a)return ram[a] or 0 end,write_u16_be=function(a,v)
