...
for _, settles in ipairs({false,true}) do
 ...
 dofile=function()return {manifest_sha256="BAE29DD285FF8D43166589164E31E1163F4196FCC1EA8DE8E2A5B90817AF7FC8"}end
 mainmemory={read_u8=function(a)return a==0xB005 and 2 or 0 end,read_u16_be=function(a)return ram[a] or 0 end,write_u16_be=function(a,v)
  ...
  ram[a]=v;writes=writes+1;if a==0xB014 then phaseSteps=0 end
 end}
 ...
 emu={framecount=function()return frames end,frameadvance=function()
  frames=frames+1;phaseSteps=phaseSteps+1;ram[0xFE04]=(ram[0xFE04] or 0)+1;ram[0xEEC2]=settles and (phaseSteps%2==0 and 0 or 8) or (phaseSteps%2==0 and 4 or 8)
 end}
 real.dofile(script)
