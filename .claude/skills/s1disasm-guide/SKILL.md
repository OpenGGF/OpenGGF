...
This disassembly is assembled with `FixBugs = 0` (docs/s1disasm/sonic.asm:20), which is what the shipped
...
There are ~327 blocks across 90 files in this tree, so this comes up regularly. Two real examples of the
