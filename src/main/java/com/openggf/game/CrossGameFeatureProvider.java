...
public class CrossGameFeatureProvider implements PlayerSpriteArtProvider, SpindashDustArtProvider {
    ...
    private PhysicsFeatureSet buildHybridFeatureSet() {
        ...
        return new PhysicsFeatureSet(
                ...
                baseFeatureSet.sidekickCatchUpYOffset(), // sidekickCatchUpYOffset (from base game)
                baseFeatureSet.sidekickFlightAutoLandFrames(), // sidekickFlightAutoLandFrames (from base game)
                baseFeatureSet.sidekickFlightMaxXStep(), // sidekickFlightMaxXStep (from base game)
                baseFeatureSet.sidekickFlightYStep(), // sidekickFlightYStep (from base game)
                baseFeatureSet.sidekickFlightLeadXOffset(), // sidekickFlightLeadXOffset (from base game)
                baseFeatureSet.sidekickFlightLeadSuppressGSpeed(), // sidekickFlightLeadSuppressGSpeed (from base game)
                ...
                baseFeatureSet.sidekickSuppressesFastLeaderTinyFollowNudge(), // sidekickSuppressesFastLeaderTinyFollowNudge (from base game)
