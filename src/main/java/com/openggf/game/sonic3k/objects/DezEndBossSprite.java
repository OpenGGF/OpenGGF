...
/** Native sprite words shared by the DEZ Act-2 encounter's SST objects. */
abstract class DezEndBossSprite extends AbstractObjectInstance implements RomWorldPositionedObject {
    protected int posX;
    protected int posY;
    ...
    DezEndBossSprite(ObjectSpawn spawn, String name) {
        super(spawn, name);
        posX = spawn.x() << 16;
        posY = spawn.y() << 16;
    }
    ...
    @Override public void appendRenderCommands(List<GLCommand> commands) {
        ...
        var renderer = getRenderer(Sonic3kObjectArtKeys.DEZ_END_BOSS);
