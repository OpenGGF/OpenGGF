...
final class Fbz2SubbossSpriteMaskChild extends AbstractFbz2SubbossChild implements RewindRecreatable, RomWorldPositionedObject {
    ...
    @Override public void update(int f,PlayableEntity p){if(root!=null&&root.controlBit(Fbz2SubbossInstance.CONTROL_DELETE_MASK))ObjectLifetimeOps.deleteNoRespawn(this);}
