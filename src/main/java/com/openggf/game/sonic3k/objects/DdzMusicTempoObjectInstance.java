 ...
 */
public final class DdzMusicTempoObjectInstance extends AbstractObjectInstance implements RewindRecreatable {
    ...
    private record RewindExtra(int selection) implements PerObjectRewindSnapshot.ObjectSubclassRewindExtra {}
    ...
    public PerObjectRewindSnapshot captureRewindState(RewindCaptureContext context) {
        return super.captureRewindState(context).withObjectSubclassExtra(new RewindExtra(selection));
    }
