 ...
 * </ul>
 */
public class Sonic1NewtronBadnikInstance extends AbstractBadnikInstance implements RewindRecreatable {
    ...
    @Override
    public Sonic1NewtronBadnikInstance recreateForRewind(RewindRecreateContext ctx) {
        return new Sonic1NewtronBadnikInstance(ctx.spawn());
    }
