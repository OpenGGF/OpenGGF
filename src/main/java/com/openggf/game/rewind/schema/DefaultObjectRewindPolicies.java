...
final class DefaultObjectRewindPolicies {
    ...
    private static final Map<FieldKey, RewindFieldPolicy> EXACT_FIELD_POLICIES = Map.ofEntries(
            ...
            // SSZ geometry and child roles are immutable construction inputs rebuilt by
            // ObjectSpawn/custom rewind constructors. Live topology still uses identity codecs.
            ...
            // each one keeps the boss. The raw collection is transient because captureRewindExtra
            // filters loc_7C91C's already-destroyed children before encoding the live ObjectRefIds;
            // each surviving child's reverse link is still captured and relinked below.
