...
public record PerObjectRewindSnapshot(
    ...
    public record PlayerRewindExtra(
        ...
        public PlayerRewindExtra(
                ...
                int lastFixedSkidDustTickFrame, short wallClimbX, int rightWallPenetrationTimer, int balanceState,
                ...
                int speedShoesRemainingTicks, boolean superSonic, boolean forceInputRight, int forcedInputMask,
                boolean forcedJumpPress, boolean suppressNextJumpPress, boolean deferredObjectControlRelease,
                boolean controlLocked, boolean hasQueuedControlLockedState, boolean queuedControlLocked,
                boolean hasQueuedForceInputRightState, boolean queuedForceInputRight, int moveLockTimer,
                boolean objectControlled, boolean objectControlAllowsCpu, boolean objectControlSuppressesMovement,
                int objectControlGeneration, int objectControlReleasedFrame, boolean suppressAirCollision,
            ...
            this(xPixel, yPixel, xSubpixel, ySubpixel, width, height, direction, layer, runningMode, xRadius, yRadius,
                    ...
                    controlLocked, hasQueuedControlLockedState, queuedControlLocked, hasQueuedForceInputRightState,
                    queuedForceInputRight, moveLockTimer, objectControlled, objectControlAllowsCpu,
                    objectControlSuppressesMovement, objectControlGeneration, objectControlReleasedFrame,
                    suppressAirCollision, suppressGroundWallCollision, forceFloorCheck, suppressedObjectMoveAndFallAxes,
                    hidden, renderFlagOnScreen, renderFlagOnScreenValid, renderHFlip, renderVFlip,
                    mgzTopPlatformSpringHandoffPending, mgzTopPlatformSpringHandoffXVel,
                    mgzTopPlatformSpringHandoffYVel, jumpInputPressed, jumpInputJustPressed,
                    jumpInputPressedPreviousFrame, upInputPressed, downInputPressed, leftInputPressed,
                    rightInputPressed, movementInputActive, logicalInputState, logicalJumpPressState, cpuControlled,
                    historyPos, followerHistoryRecordedThisTick, spiralActiveFrame, flipAngle, flipType, flipSpeed,
                    flipsRemaining, flipTurned, inWater, waterPhysicsActive, wasInWater, waterSkimActive,
        ...
        public PlayerRewindExtra(
            ...
            this(xPixel, yPixel, xSubpixel, ySubpixel, width, height, direction, layer, runningMode, xRadius, yRadius,
                    ...
                    pinballSpeedLock, preserveRollingOnNextLanding, preserveRollingOnNextRollStop,
                    objectPreservedRollBoostFollowup, objectPreservedRollWallProbe, objectPreservedRollVelocityCarry,
                    tunnelMode, onObject, onObjectAtFrameStart, false, pushingAtFrameStart, hurtAtFrameStart,
                    ...
                    invulnerableFrames, suppressNextInvulnerabilityDecrement, false, invincibleFrames, spindash,
