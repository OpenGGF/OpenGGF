...
public class LevelTilemapManager {
     ...
     * must stay cheap. A normal BG window is a pure function of restored camera-X
     * plus static layout, so the next-frame {@code ensureBackgroundTilemapData}
     * full-build path does the actual rebuild. An exact event-owned Plane-B image
     * installed during the preceding reconciliation is retained instead; forward
     * event bytes without such reconciliation are rejected as stale.
     * <p>
