...
/**
 * Builds the neutral observation pacing contract for one recorded
...
public final class SpecialStageRecordedPassPacing {
    ...
    /** Neutral pacing contract adapted at the package-private game-loop boundary. */
