...
public final class ModApiSignatureSurface {
    ...
    private static final Set<Class<?>> ALLOWED_PLATFORM_TYPES = Set.of(
            ...
            java.io.BufferedReader.class, java.io.IOException.class, java.io.InputStream.class,
    ...
    private static final Set<String> ENGINE_INTERNAL_TYPES = Set.of(
            ...
            // Develop-side runtime, trace, and load-admission plumbing reached by
            // otherwise stable creator roots. These capabilities remain engine
            // owned; merging them must not silently widen the 0.7 creator API.
            "com.openggf.data.RomGame",
            "com.openggf.data.RomManager",
            "com.openggf.game.RuntimeArtAdmissionLease",
            "com.openggf.game.RuntimeArtAdmissionOwnerKind",
            "com.openggf.game.RuntimeArtAdmissionPolicy",
            "com.openggf.game.SpecialStageDebugCapabilities",
            "com.openggf.game.MasterTitleScreen$AudioCue",
            "com.openggf.game.MasterTitleScreen$AudioSink",
            "com.openggf.game.resources.DynamicArtDecisionOwner",
            "com.openggf.game.resources.DynamicArtDiagnosticsProvider",
            "com.openggf.game.resources.DynamicArtDiagnosticsSnapshot",
            "com.openggf.game.resources.DynamicArtGapDiagnosticsSnapshot",
            "com.openggf.game.resources.DynamicArtGapTransition",
            "com.openggf.game.resources.DynamicArtLifecycleService",
            "com.openggf.game.resources.DynamicArtLifecycleService$ArtUpdate",
            "com.openggf.game.resources.NativeFadeLifecycle",
            "com.openggf.game.resources.PlcFrameLifecycleCoordinator",
            "com.openggf.game.resources.PlcLifecyclePhase",
            "com.openggf.game.resources.PlcLifecycleService",
            "com.openggf.game.resources.QueueDiagnosticSnapshot",
            "com.openggf.game.resources.QueueDiagnosticsProvider",
            "com.openggf.game.resources.QueueServiceObservation",
            "com.openggf.game.rules.DynamicArtDmaServiceModel",
            "com.openggf.game.rules.PlayerLevelBoundaryRules",
            "com.openggf.game.rules.TailsTailPushDetection",
            "com.openggf.game.timing.LoadTimeProfile",
            ...
            "com.openggf.trace.DynamicArtTransfer$ComparisonEdge",
            "com.openggf.trace.DynamicArtTransfer$Descriptor",
            "com.openggf.trace.DynamicArtTransfer$Request",
            "com.openggf.trace.DynamicArtTransfer$SegmentEdge",
            "com.openggf.trace.EngineSnapshot",
            "com.openggf.trace.StoredPhysicsFrameDomain",
            "com.openggf.trace.StoredPhysicsFrameDomain$FrameEncoding",
            "com.openggf.trace.TraceExecutionPhase",
            "com.openggf.trace.TraceHudModel",
            "com.openggf.trace.TraceEvent$DynamicArtTransferState",
            "com.openggf.trace.TraceEvent$LoadQueueState",
            "com.openggf.trace.TraceEvent$LoadQueueState$ServiceObservation",
            "com.openggf.trace.replay.runs.RunLevelLoadCause",
            "com.openggf.trace.replay.runs.RunLevelLoadTracker",
            "com.openggf.trace.replay.runs.RunPlaybackObservation$LevelIdentity",
            "com.openggf.trace.replay.runs.TraceRunFrameDriver",
            "com.openggf.trace.replay.runs.TraceRunPlaybackCoordinator$Phase",
            "com.openggf.trace.replay.runs.TraceRunReplayWalker$SegmentExecutionPolicy");
