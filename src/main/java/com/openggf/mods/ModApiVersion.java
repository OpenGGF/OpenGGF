...
public final class ModApiVersion {
     ...
     *       changed. Retained as a closed historical baseline.</li>
     *   <li><b>2.5.0</b> ({@code mod-api-signatures-2.5.txt}) — an additive minor
     *       bump over 2.4.0 that publishes the reviewed runtime evolution while
     *       preserving every frozen 2.4 constructor and member through compatibility
     *       overloads and aliases. Engine-only controller and runtime-art queue
     *       helpers remain outside the creator surface. This is the currently
     ...
     * declared breaking transition, and 2.0 -&gt; 2.1 -&gt; 2.2 -&gt; 2.3 -&gt; 2.4 -&gt; 2.5 is asserted additive
     ...
     * ("Mod API 2.0.0 breaking transition" and the 2.1.0 through 2.5.0 additive
     * bump sections) for the migration notes.
     */
    public static final SemanticVersion CURRENT = SemanticVersion.parse("2.5.0");
