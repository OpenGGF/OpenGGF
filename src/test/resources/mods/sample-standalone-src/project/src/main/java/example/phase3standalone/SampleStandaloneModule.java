...
public final class SampleStandaloneModule extends AbstractStandaloneGameModule {
    ...
    private final PhysicsProfile profile = new PhysicsProfile(
            (short) 0x18, (short) 0x80, (short) 0x18, (short) 0x500, (short) 0x700,
    ...
    private final LevelInitProfile levelInitProfile = new StandaloneInitProfile();
    ...
    @Override public Game createGame(GameDataSource source) { return new SampleGame(owner, source, level); }
    ...
    @Override public ObjectRegistry createObjectRegistry() { return new SampleRegistry(); }
    ...
    @Override public ZoneRegistry getZoneRegistry() { return new SampleZones(owner); }
    ...
    private static final class SampleGame extends ModGame {
        private final Level level;
        private SampleGame(String owner, GameDataSource source, Level level) {
    ...
    private static final class SampleZones implements ZoneRegistry {
        private final String owner;
        private SampleZones(String owner) { this.owner = owner; }
        @Override public int getZoneCount() { return 1; }
        @Override public int getActCount(int zoneIndex) { requireZone(zoneIndex); return 1; }
        @Override public String getZoneName(int zoneIndex) { requireZone(zoneIndex); return "SAMPLE PLAINS"; }
        @Override public int[] getStartPosition(int zoneIndex, int actIndex) {
            require(zoneIndex, actIndex); return new int[] { 32, 96 };
        }
        ...
        private static LevelDescriptor descriptor() { return new LevelDescriptor() {
            ...
            @Override public int startX() { return 32; }
            @Override public int startY() { return 96; }
        }; }
    ...
    private static final class StandaloneInitProfile extends AbstractLevelInitProfile {
        ...
        @Override protected InitStep levelEventTeardownStep() {
            return new InitStep("ResetStandaloneLevelEvents", "standalone", () -> { });
        }
