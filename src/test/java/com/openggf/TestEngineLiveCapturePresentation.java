...
class TestEngineLiveCapturePresentation {
    ...
    void productionDisplayHasOneUnconditionalCoordinatorInvocation() throws Exception {
        ...
        int displayStart = source.indexOf("private boolean display()");
        // Bound at the first helper after display(); the shared static seams that
        // follow it are not part of the presented frame.
        int displayEnd = source.indexOf("static boolean runFrameWithModAbort(", displayStart);
