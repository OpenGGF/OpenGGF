...
class TestRemainingRewindTailInventory {
    ...
    private static TailInventory loadInventory() {
        ...
        assertEquals(23, buckets.get(Bucket.NO_PROBE_CTOR).size(), "no-probe-ctor inventory count");
        assertEquals(102, buckets.get(Bucket.PARENT_DEPENDENT).size(), "parent-dependent inventory count");
        ...
        return new TailInventory(783, 643, 15, 0, buckets);
    }
