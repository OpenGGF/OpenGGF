...
class TraceReplaySessionBootstrapConfigTest {
    ...
    void restoreGameplayConfigRoundtripsUserPreferences() {
        ...
        // returns true (current pre-level prefix traces). This stub doesn't
        // qualify, so the user's true stays in place and is therefore already
        // restored by the roundtrip.
