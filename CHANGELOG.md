...
- [0.7 roadmap](docs/project/v0.7-roadmap.md) — post-0.6 route completion,
  Mod API, multiplayer, Time Attack, editor, Super Emerald, packaging, and
  compatibility work staged on `next`.
