...
- **Sonic 2 sidekick chaining:** Tails fly-in and normal follow now target a direct CPU leader as soon as that leader reaches normal gameplay, avoiding a 15-frame settled-threshold pause after a Sonic sidekick lands.
