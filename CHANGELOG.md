...
- **S2 CPZ rewind graph restore:** CPZ boss main-linked child objects now restore through generic recreate with graph-level tests for identity, counts, and parent references.
