...
- **Sonic 2 sidekick chaining:** trailing sidekicks now keep following the root leader while a freshly landed direct Sonic sidekick warms its delayed follow-history ring, then rejoin the direct CPU-leader chain once that history is usable.
