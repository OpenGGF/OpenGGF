...
- **Sonic 1 palette cycles, bridge bend tables, conveyor path/spawn data, and
  ...
  `Map_Newt`, GHZ Buzz Bomber `Map_Buzz` / `Map_Missile`, GHZ/SLZ smash-wall `Map_Smash`, LZ/SLZ/SBZ Orbinaut `Map_Orb`, LZ harpoon `Map_Harp`, MZ/SBZ Caterkiller `Map_Cat`, SBZ Ball Hog
