...
- **S2 top-level badnik scalar rewind coverage:** Asterons, Chop Chops, Cluckers, Coconuts, Crawltons, Flashers, Mashers, Nebulas, Octuses, and Spikers now rebuild through generic rewind recreate without stale constructor-scalar baselines.
