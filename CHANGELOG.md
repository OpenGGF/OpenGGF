...
- **Sonic 1 palette cycles, bridge bend tables, conveyor path/spawn data, and
  ...
  MZ Basaran/Batbrain `Map_Bas`, MZ glass block `Map_Glass`, MZ lava geyser `Map_Geyser`, GHZ spiked pole helix `Map_Hel`, SYZ bumper
  ...
  Giant Ring `Map_GRing` and Ring Flash `Map_Flash`,
