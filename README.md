...
- **Mod support:** Phases 0–2 provide patch composition, editor/export foundations, strict restart-scoped discovery, bounded WAV/Ogg stock-music overrides, trusted code-backed objects, art reskins, complete Sonic 2 zones, tagged saves, and the two-artifact `ggfmod` toolchain. Phase 3 publishes the additive Mod API 1.2 character and standalone seams: owner-tagged playable factories/physics/art/abilities, baked `.ggfp` sheets, no-ROM game modules and levels, dynamic master-title New Game/Continue entries, namespaced streamed music, and bounded standalone SFX. S1/S3K new-zone adapters, base-game SFX overrides, MP3, and hot reload remain future work. See [Content mods](docs/modding/content-mods.md), [Playable characters](docs/modding/characters.md), [Standalone games](docs/modding/standalone-games.md), and [Music packs](docs/modding/music-packs.md).
